    ...
    try {
      ...
      if (image) {
        try {
          ...
          console.error('Upload failed:', uploadErr.response?.data);
          setError('Image upload failed: ' + (uploadErr.response?.data?.message || 'Unknown error'));
          setLoading(false);
          return;
        }
      }

      const { data } = await axios.post(`/restaurants/${id}/dishes`, {
        name: formData.name,
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          <h1 style={styles.title}>Add a Dish</h1>
          <p style={styles.subtitle}>Add a dish to this restaurant</p>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            <div style={styles.imageUpload}>
              {imagePreview ? (
                ...
                <div style={styles.imagePlaceholder}>
                  ...
                  <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>Upload dish photo</p>
                </div>
              )}
              <input
                type="file"
                ...
                id="dishImage"
              />
              <label htmlFor="dishImage" style={styles.uploadBtn}>
            ...
            <div style={styles.inputGroup}>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Basmati rice, mutton, saffron..."
                style={styles.input}
              />
            </div>
            ...
            <div style={styles.row}>
              <div style={styles.inputGroup}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Spicy and aromatic"
                  style={styles.input}
                />
              </div>
              <div style={styles.inputGroup}>
