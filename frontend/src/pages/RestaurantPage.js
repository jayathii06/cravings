...
const styles = {
  ...
  heroTitle: { fontSize: '2rem', fontWeight: '800', marginTop: '0.5rem', marginBottom: '0.25rem' },
  heroLocation: { fontSize: '0.9rem', opacity: 0.85, marginBottom: '0.5rem' },
  heroDesc: { fontSize: '0.875rem', opacity: 0.8, marginBottom: '1rem', maxWidth: '500px' },
  bookmarkBtn: {
  ...
  bookmarkActive: { background: 'var(--primary)', border: '1.5px solid var(--primary)' },
  container: { maxWidth: '1200px', margin: '0 auto', padding: '2rem' },
  sectionTitle: { fontSize: '1.4rem', fontWeight: '700', color: 'var(--text-primary)' },
  empty: { textAlign: 'center', padding: '3rem', color: 'var(--text-secondary)' },
  dishGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1.25rem' },
  ...
  dishName: { fontSize: '1rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '0.4rem' },
  dishFlavor: { fontSize: '0.8rem', color: 'var(--text-secondary)', marginBottom: '0.25rem' },
  dishIngredients: {
    fontSize: '0.78rem', color: 'var(--text-secondary)', marginBottom: '0.5rem',
    display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden'
  },
  dishFooter: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.5rem' },
  dishWeight: { fontSize: '0.8rem', color: 'var(--text-secondary)' },
  dishPrice: { fontSize: '1rem', fontWeight: '700', color: 'var(--primary)' }
};
